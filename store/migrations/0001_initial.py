...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('category', '0002_alter_category_meta_description_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='unique value for product page url, created from product name', max_length=255, unique=True)),
                ...
                ('meta_keywords', models.CharField(blank=True, help_text='Comma-delimited set of SEO keywords for meta tag', max_length=255)),
